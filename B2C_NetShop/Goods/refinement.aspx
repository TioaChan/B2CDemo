...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="content_main" style="display: block">
        <div id="list_detail" style="width: 100%; text-align: center; margin-left: 10px; margin-right: 10px; margin-top: 20px; padding-top: 10px; padding-right: 10px; padding-left: 10px;">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:B2C_DemoConnectionString %>" SelectCommand="SELECT [ClassID], [BookID], [BookName], [Author], [MarketPrice] FROM [Goods_Info] WHERE (([ClassID] = @ClassID) AND ([Isrefinement] = @Isrefinement))">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:B2C_DemoConnectionString %>" SelectCommand="SELECT [ClassID], [BookID], [BookName], [Author], [MarketPrice] FROM [Goods_Info] WHERE (([ClassID] = @ClassID) AND ([Isrefinement] = @Isrefinement))">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:B2C_DemoConnectionString %>" SelectCommand="SELECT [ClassID], [BookID], [BookName], [Author], [MarketPrice] FROM [Goods_Info] WHERE (([ClassID] = @ClassID) AND ([Isrefinement] = @Isrefinement))">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:B2C_DemoConnectionString %>" SelectCommand="SELECT [ClassID], [BookID], [BookName], [Author], [MarketPrice] FROM [Goods_Info] WHERE (([ClassID] = @ClassID) AND ([Isrefinement] = @Isrefinement))">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:B2C_DemoConnectionString %>" SelectCommand="SELECT [ClassID], [BookID], [BookName], [Author], [MarketPrice] FROM [Goods_Info] WHERE (([ClassID] = @ClassID) AND ([Isrefinement] = @Isrefinement))">
                <SelectParameters>
