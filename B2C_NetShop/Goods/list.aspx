...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div id="content_main" style="display: block">
        <div id="list_detail" style="height: auto; width: 900px; text-align: center; margin-left: 60px; margin-right: 60px; margin-top: 20px; padding-top: 10px; padding-right: 25px; padding-left: 25px;">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:B2C_DemoConnectionString %>" SelectCommand="SELECT [BookID], [BookName], [Author], [MarketPrice], [picUrl] FROM [Goods_Info] WHERE ([ClassID] = @ClassID)">
                <SelectParameters>
